...
<div class="usertitle1 m_l_6" id="tab1"><a href="apphistory.jsp">应用订购记录</a></div>
<div class="usertitle" id="tab2">下载安全域历史</div>
</div>
...
<table width="710" height="56" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="210" align="center"><input type="button" id="sendCheck" value="搜索"></input><input type="button" id="refresh" value="刷新"></td>
  </tr>
</table>
</div>
<div class="w720">
