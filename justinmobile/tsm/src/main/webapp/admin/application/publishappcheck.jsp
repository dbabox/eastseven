...
<dd id="typeTktd"><p class="regtext">传输密钥索引:</p><p class="left inputs">
<input id="typeTk" class="inputtext  validate['digit']" maxlength="100"  name="typeTk" type="text" /></p>
</dd>
...
<dd  id="typeKektd"><p class="regtext">敏感数据加密密钥索引:</p><p class="left inputs">
<input id="typeKek" class="inputtext  validate['digit']" maxlength="100"  name="typeKek" type="text" /></p>
</dd>
<dd id="kekVersiontd"><p class="regtext">敏感数据加密密钥版本:</p><p class="left inputs">
<input id="kekVersion" class="inputtext  validate['digit']" maxlength="100"  name="kekVersion" type="text" /></p>
</dd>
<dd id="kekVendortd"><p class="regtext">敏感数据加密机厂商:</p><p class="left inputs">
<select id="kekVendor"  name="kekVendor"></select></p>
</dd>
<dd>
