						...
						onSuccess : function(){
							...
							if(card.cardAppInfo.length>0){
								...
								Array.each(card.cardAppInfo,function(app,index){
								    	if(app.statusOriginal != 1){
        									...
        									html += "<td>" + app.appVer + "</td>";
        									html += "<td>" + app.status + "</td>";
        									html += "<td>" + cardInfo.formatSize(app.loadFileRam) + "</td>";
        									html += "<td>" + cardInfo.formatSize(app.loadFileRom) +"</td>";
        									html += "<td>" + cardInfo.formatSize(app.appletRam) + "</td>";
        									html += "<td>" + cardInfo.formatSize(app.appletRom) + "</td>";
        									html += "<td>" + app.sdName + "</td>";
        									html += "</tr>";
        									hide = false;
								    	}
								});
							...
							if(card.cardSdInfo.length>0){
								...
								Array.each(card.cardSdInfo,function(sd,index){
									...
									html += "<td>" + sd.appMod + "</td>";
									html += "<td>" + sd.status + "</td>";
									html += "<td>" + cardInfo.formatSize(sd.sdUsedRam) + "</td>";
									html += "<td>" + cardInfo.formatSize(sd.sdAviliableRam) + "</td>";
									html += "<td>" + cardInfo.formatSize(sd.sdUsedRom) + "</td>";
									html += "<td>" + cardInfo.formatSize(sd.sdAviliableRom) + "</td>";
									html += "</tr>";
									hide = false;
								    }
								});
