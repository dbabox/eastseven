...
<script type="text/javascript" src="${ctx}/lib/formcheck/formcheck.js">
...
<body>
	<div id="container">
		...
		<div id="footer" class="clear">
			<p class="right">Copyright©2011 Just In Mobile Corporation. All
				rights reserved</p>
		</div>
	</div>
			...
			<form method="post">
				...
				<dl>
					...
					<dd>
						...
						<p class="left inputs">
							<!-- c915450107470202024801ff49060190000007d04a0105 -->
							<input
