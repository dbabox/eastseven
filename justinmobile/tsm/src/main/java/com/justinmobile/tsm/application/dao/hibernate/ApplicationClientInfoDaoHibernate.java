...
public class ApplicationClientInfoDaoHibernate extends EntityDaoHibernate<ApplicationClientInfo, Long> implements ApplicationClientInfoDao {
	...
	@Override
	public ApplicationClientInfo getByApplicationVersionAndSysRequirmentAndFileTypeAndVersion(ApplicationVersion applicationVersion,
	...
	@Override
	public ApplicationClientInfo getByApplicationVersionTypeVersionFileType(ApplicationVersion applicationVersion, String sysType,
	...
	@Override
	public Page<ApplicationClientInfo> getApplicationClientInfoForIndex(final Page<ApplicationClientInfo> page, Map<String, Object> values) {

		Map<String, Object> _values = new HashMap<String, Object>(3);
		StringBuffer hql = new StringBuffer("select aci from " + ApplicationClientInfo.class.getName() + " as aci where busiType=:busiType");
		...
		if (!StringUtils.isEmpty(values.get("name").toString())) {
			...
			String type = values.get("name").toString().replaceAll(" ", "  ").replaceAll("%", " %").replaceAll("_", " _");
			type = "%" + type + "%";
	...
	@Override
	public Integer getMaxVersionCode(Integer busiType, String sysType,
