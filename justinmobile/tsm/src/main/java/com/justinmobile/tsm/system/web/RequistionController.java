...
public class RequistionController {
	...
	JsonMessage updatePublish(HttpServletRequest request) {
		...
		try {
			...
			String tkVersion = ServletRequestUtils.getStringParameter(request, "tkVersion", "");
			String kekVersion = ServletRequestUtils.getStringParameter(request, "kekVersion", "");
			...
			message = requistionManager.updatePublish(status, typeOriginal, sdIdsStr, opinion, ac, typeTk, typeKek,
					tkVersion, kekVersion, tkVendor, kekVendor);
