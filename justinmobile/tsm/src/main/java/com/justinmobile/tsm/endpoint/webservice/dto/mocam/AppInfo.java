...
//		}
		...
		this.setSmallCardURL("/html/application/?m=getAppMobileImgByAid&aId="+app.getAid());
		pictureUrlList = new PictureURLList();
		for(ApplicationImage appi:app.getApplicationImages()){
			pictureUrlList.add("html/application/?m=getAppImg&appImgId="+appi.getId());
		}
		this.setPictureURLList(pictureUrlList);
		this.setAppLogoURL("/html/application/?m=getAppPcImg&appId="+app.getId());
