...
public class SecureUtil {
	...
	public static byte[] singleDesCbcMac(byte[] keyBytes, byte[] paddedMacSource, byte[] initVector)
	...
	public static byte[] encryptDesCbc(byte[] keyBytes, byte[] paddedEncSource, byte[] initVector)
			throws CryptoException {
		if (keyBytes == null || keyBytes.length != 8) {
			throw new CryptoException("error key length");
		}
	...
	public static byte[] encryptTripleDesCbc(byte[] kap, byte[] kbp, byte[] paddedEncSource, byte[] initVector)
			throws CryptoException {
		if (kap == null || kap.length != 8 || kbp == null || kbp.length != 8) {
			throw new CryptoException("error kap and kbp");
		}
	...
	public static byte[] fullTripleDesCbc2KeyMac(byte[] paddedMacSource, byte[] kap, byte[] kbp, byte[] initVector)
			throws CryptoException {
		if (kap == null || kap.length != 8 || kbp == null || kbp.length != 8) {
			throw new CryptoException("error kap and kbp");
		}
