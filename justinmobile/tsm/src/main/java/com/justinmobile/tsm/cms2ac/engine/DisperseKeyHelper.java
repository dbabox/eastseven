...
public class DisperseKeyHelper {
	...
	private byte[] getScp02ThirdSalt(int keyType, String cardNo, SecurityDomain securityDomain) {
		...
		CardSecurityDomain cardSecurityDomain = cardSecurityDomainManager.getByCardNoAid(cardNo, securityDomain.getAid());
		int keyVersion = cardSecurityDomain.getScp02EncKey().getVersion();
