...
import static com.justinmobile.core.utils.ByteUtils.arrayShortHexString;
...
public class CryptoUtils {
	...
	public static void main(String[] args) {
		try {
			byte[] kap = "grant yu".getBytes();
			byte[] kbp = "yu qiman".getBytes();
			byte[] src = "i'll always love mimi".getBytes();// new byte[] { 111,
															// -32, -5, 47, 89,
															// -44, -77, -127 };

			System.out.println("kap = " + toHexString(kap));
			System.out.println("kbp = " + toHexString(kbp));
			System.out.println("src = " + toHexString(src));
			String dst = null;
			dst = toHexString(encryptTripleDES(kap, kbp, src));
			System.out.println("dst = " + dst);
			byte[] dcr = decryptTripleDES(kap, kbp, ConvertUtils.hexString2ByteArray(dst));
			System.out.println("dcr = " + toHexString(dcr));
			System.out.println("---------------------");
			byte[] en1 = encryptDES(kap, src);
			System.out.println("en1 = " + toHexString(en1));
			byte[] de2 = decryptDES(kbp, en1);
			System.out.println("de2 = " + toHexString(de2));
			byte[] en3 = encryptDES(kap, de2);
			System.out.println("en3 = " + arrayShortHexString(en3, " "));
