...
public class RegexUtil {
	 ...
	 * SPAN
	 */
	public final static String REGEX_SPAN_ALL = "<[sS][pP][aA][nN]\\s+[^>]+>|<[sS][pP][aA][nN]>|</[sS][pP][aA][nN]>";

	public final static String REGEX_SPAN_START = "<[sS][pP][aA][nN]\\s+[^>]+>";
	
	public final static String REGEX_SPAN_START_NO_ATTR = "<[sS][pP][aA][nN]>";

	public final static String REGEX_SPAN_END = "</[sS][pP][aA][nN]>";
