 ...
 * @author dongq
 * 
 *         create time : 2009-11-24 ÉÏÎç09:27:39
 */
public class SubscribeManagementComposer extends GenericForwardComposer {
	...
	public SubscribeManagementComposer() {
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		if(obj != null && arg != null){
			...
			List<SubscribeBean> list = dao.getSubscribeList(user.getUserId(), bean.getChannelId());
	...
	public void onClick$del(){
		if(subscribeListbox.getSelectedCount() > 0){
			...
			if(bln){
				List<SubscribeBean> _list = dao.getSubscribeList(user.getUserId(), bean.getChannelId());
