...
public class ChannelMappingDao {
	...
	public Boolean save(Long userId,String localCode, String localChannelId, String channelId){
		Boolean bln = false;
		Connection conn = null;
		PreparedStatement pst = null;
		ResultSet rs = null;
	...
	public Boolean deleteBatch(Long userId, String[] ids){
		boolean bln = false;
		Connection conn = null;
		PreparedStatement pst = null;
		ResultSet rs = null;
		String sql = " delete twap_public_channel_mapping a where a.mapping_id = ? and a.user_id = ? ";
		try{
			conn = JavaOracle.getConn();
