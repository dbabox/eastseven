 ...
 * 
 */
package com.bcinfo.wapportal.repository.crawl.ui.zk.pages.system.quartz;
 ...
 * @author dongq
 * 
 *         create time : 2009-12-14 下午12:44:48
 */
public class BorderLayoutComposer extends GenericForwardComposer {
	...
	class ChannelTreeitemListener implements EventListener {
		...
		public void onEvent(Event event) throws Exception {
			...
			Executions.createComponents("/pages/system/quartz/quartz_list.zul", tabpanel, map);
