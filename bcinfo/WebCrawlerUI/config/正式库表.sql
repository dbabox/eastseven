...
create index TWAP_CHANNEL_IDX_1 on TWAP_PUBLIC_CHANNEL (CHANNEL_PID);
/*==============================================================*/
...
create table TWAP_PUBLIC_CRAWL_RESOURCE  (
   ...
   RES_FILE_PATH_SET   VARCHAR2(4000),/*alter table TWAP_PUBLIC_CRAWL_RESOURCE add RES_FILE_PATH_SET  VARCHAR2(4000)*/
...
create index TWAP_CRAWL_RESOURCE_IDX_1 on TWAP_PUBLIC_CRAWL_RESOURCE (CHANNEL_ID);
create index TWAP_CRAWL_RESOURCE_IDX_2 on TWAP_PUBLIC_CRAWL_RESOURCE (RES_TITLE);
create index TWAP_CRAWL_RESOURCE_IDX_3 on TWAP_PUBLIC_CRAWL_RESOURCE (RES_STATUS);
create index TWAP_CRAWL_RESOURCE_IDX_4 on TWAP_PUBLIC_CRAWL_RESOURCE (CREATE_TIME);
...
tablespace NX_DATA4;
create index TWAP_CRAWL_RES_STA_IDX_1 on TWAP_PUBLIC_CRAWL_RESOURCE_STA (CHANNEL_ID);
create index TWAP_CRAWL_RES_STA_IDX_2 on TWAP_PUBLIC_CRAWL_RESOURCE_STA (RES_TITLE);
create index TWAP_CRAWL_RES_STA_IDX_3 on TWAP_PUBLIC_CRAWL_RESOURCE_STA (RES_STATUS);
create index TWAP_CRAWL_RES_STA_IDX_4 on TWAP_PUBLIC_CRAWL_RESOURCE_STA (CREATE_TIME);
